...
якщо на зображенні немає вишиванки, якість фото замала, або виникла помилка під час аналізу - виведи єдиний рядок який починається на '#' і після цього символа йде коротке пояснення причини помилки (до 50 символів)
якщо попередня умова виконується - всі наступні вимоги ігноруй
